...
export default function About() {
  ...
  return (
    <section id="about" className="h-full flex flex-col px-8 md:px-16">
      <div className="shrink-0 flex items-center gap-4 mb-8 pt-6 md:pt-0">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        <div className="grid gap-11 items-center grid-cols-1 md:grid-cols-[340px_1fr] pb-6">
